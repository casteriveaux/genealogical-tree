...
x means ID of family family_group (Family Group)
...
== Screenshots ==
1. Member page (Admin area)
2. Import GED (Pro)
3. Import GED Sucess (Pro)
4. Family list page
5. Tree
6. Tree Support Popup detals on click (Pro)
7. Member page (Front end)
