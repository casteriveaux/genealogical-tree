           ...
           <!--  <h2>Settings</h2> -->
            ...
            <table class="form-table">
                <tr>
                    <th>
                        Enable Import (.ged) 
                        <p class="description"><i>It will allow you to import members from a ged formated file.</i></p>
                    </th>
                ...
                <tr>
                    <th>
                        Enable Export (.ged) 
                        <p class="description"><i>It will allow you to export members and family to a ged formated file.</i></p>
                    </th>
                    <td>
                        <input type="checkbox"  name="gt[enable_import]" disabled="disabled"> 
                ...
                <tr>
                    <th>
                        Hide Credit Text
                        <p class="description"><i>This will Credit Text</i></p>
                    </th>
                    <td>
                        <input type="checkbox" name="gt[enable_import]"  disabled="disabled"> 
                    </td> 
